...
<nav id="sidebar" class="sidebar-wrapper">
	<div class="sidebar-content">
		...
		<div class="sidebar-header">
			<div class="user-pic">
				<img class="img-responsive img-rounded" src="storage/img/avatar2.png" alt="User picture">
			</div>
			<div class="user-info">
			...
			<ul>
				...
				<li class="sidebar-dropdown">
					...
					<div class="sidebar-submenu">
						<ul>
							<li>
								<a href="duserprof.php">All User</a>
							</li>
							<li>
								<a href="#">Add New</a>
							</li>
				...
				<li class="sidebar-dropdown">
					...
					<div class="sidebar-submenu">
						<ul>
							<li>
								<a href="#" title="General Settings">General</a>
							</li>
							<li>
								<a href="#">Media</a>
							</li>
				...
				<li>
					<a href="#" title="Create Read Update Delete Search">
